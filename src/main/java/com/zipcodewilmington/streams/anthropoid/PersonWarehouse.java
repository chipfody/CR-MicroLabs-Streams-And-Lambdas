...
public final class PersonWarehouse implements Iterable<Person> {
    ...
    public List<String> getNames() {
        ...
        return people.stream ().map(people -> people.getName ()).collect( Collectors.toList ());
    }
    ...
    public Stream<Person> getUniquelyNamedPeople() {
        Set<String> peopleStream = new HashSet<> (  );
        return people.stream ().filter ( person -> peopleStream.add(person.getName ()));
    }
    ...
    public Stream<Person> getUniquelyNamedPeopleStartingWith(Character character) {
        ...
        return getUniquelyNamedPeople ().filter (people -> people.getName ().startsWith ( character.toString ()));
    }
    ...
    public Map<Long, String> getIdToNameMap() {
        ...
        Map<Long, String> idToNameMap = people.stream ().collect ( Collectors.toMap (Person :: getPersonalId, Person :: getName));
        return idToNameMap;
    }
